...
const SCHEMA_SQL = [
  `CREATE TABLE IF NOT EXISTS "users" ("id" TEXT NOT NULL PRIMARY KEY, "firebase_uid" TEXT NOT NULL, "email" TEXT NOT NULL, "display_name" TEXT, "photo_url" TEXT, "tier" TEXT NOT NULL DEFAULT 'free', "stripe_customer_id" TEXT, "stripe_subscription_id" TEXT, "onboarding_done" BOOLEAN NOT NULL DEFAULT false, "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)`,
