...
signalRouter.get('/', requireAuth, async (req, res) => {
...
signalRouter.get('/:id', requireAuth, async (req, res) => {
...
/** GET /api/v1/trades — Trade tracker with current prices */
signalRouter.get('/trades', requireAuth, async (req, res) => {
